...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(// QWERTY
            GUI_T(KC_QUOT), LALT_L(KC_COMM), KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, RALT_T(KC_L),
            KC_A, KC_S, KC_E, KC_U, KC_I, KC_D, KC_H, KC_T, KC_L, KC_S,
            GUI_T(KC_SCLN), LALT_T(KC_Q), KC_J, KC_K, KC_X, KC_B, KC_M, KC_W, LALT_T(KC_V), GUI_T(KC_Z),
                    MO(3), CTL_SPACE), MO(2), LALT_T(KC_ENT)),
	[1] = LAYOUT( //  colmaksu
