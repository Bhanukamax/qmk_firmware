...
const uint16_t PROGMEM combo_2[] = {TAP_COMM, HM_O, COMBO_END};
const uint16_t PROGMEM combo_3[] = {KC_DOT, HM_E, COMBO_END};
...
const uint16_t PROGMEM combo_8[] = {KC_C, HM_T, COMBO_END};
